...
# Create the third public subnet in the VPC for external traffic.
...
# Create the third private subnet in the VPC for internal traffic.
...
# Create the third private subnet route table.
...
# Associate the private subnet route table to the third private subnet.
...
# Associate the public subnet route table to the third public subnet.
